...
const Winner = () => {
    return (
              ...
              <div className="col-12">
                <div className="page-header-content text-center">
                  <div className="page-header-caption">
                    <h2 className="page-title">Auction Winners</h2>
        ...
        {/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            Start Winner Page Block
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
        <div className="winner-page-block ptb-120">
          <div className="container">
            <div className="row justify-content-center winner-list-area">
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="winner-item">
                  <div className="winner-thumb">
                    <img src="assets/images/winner/w4.jpg" alt="img" />
                    <div className="winner-auction-product">
                      <div className="product-icon">
                        <span className="icon-gift" />
                      </div>
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="winner-item">
                  <div className="winner-thumb">
                    <img src="assets/images/winner/w7.jpg" alt="img" />
                    <div className="winner-auction-product">
                      <div className="product-icon">
                        <span className="icon-gift" />
                      </div>
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="winner-item">
                  <div className="winner-thumb">
                    <img src="assets/images/winner/w8.jpg" alt="img" />
                    <div className="winner-auction-product">
                      <div className="product-icon">
                        <span className="icon-gift" />
                      </div>
              ...
              <div className="col-lg-3 col-md-4 col-sm-6">
                <div className="winner-item">
                  <div className="winner-thumb">
                    <img src="assets/images/winner/w9.jpg" alt="img" />
                    <div className="winner-auction-product">
                      <div className="product-icon">
                        <span className="icon-gift" />
                      </div>
