...
const deals = () => {
    return (
              ...
              <div className="col-12">
                <div className="page-header-content text-center">
                  <div className="page-header-caption">
                    <h2 className="page-title">deals of the day</h2>
        ...
        {/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            Start Deals Page Block
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/}
        <div className="deals-page-block ptb-120">
          <div className="container">
            <div className="row items-two-1199">
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">JBL GO Digital Drone</a></h3>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">BBB Bluetooth Headphone</a></h3>
                    <div className="auction-id">Auction ID: BB28111</div>
                  </div>{/* /.item-footer */}
                  <div className="item-img">
                    <a href="#/">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">Android Mobile Phone</a></h3>
                    <div className="auction-id">Auction ID: BB28111</div>
                  </div>{/* /.item-footer */}
                  <div className="item-img">
                    <a href="#/">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">Digital Headphone</a></h3>
                    <div className="auction-id">Auction ID: BB28111</div>
                  </div>{/* /.item-footer */}
                  <div className="item-img">
                    <a href="#/">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">Realistic Watche</a></h3>
                    <div className="auction-id">Auction ID: BB28111</div>
                  </div>{/* /.item-footer */}
                  <div className="item-img">
                    <a href="#/">
              ...
              <div className="col-lg-4 col-md-6">
                <div className="auction-item">
                  <div className="item-header">
                    <h3 className="heading"><a href="auction-details.html">JBL GO White Drone</a></h3>
                    <div className="auction-id">Auction ID: BB28111</div>
                  </div>{/* /.item-footer */}
                  <div className="item-img">
                    <a href="#/">
